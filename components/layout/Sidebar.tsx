...
import {
  ...
  Sun, Moon, PieChart, LogOut, User, Tag, FlaskConical, Lightbulb,
} from "lucide-react";
...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dicas", label: "Dicas do Mês", icon: Lightbulb },
    ],
  },
  {
    label: "Sistema",
...
export function Sidebar() {
  ...
  return (
    <aside className="h-full w-full bg-slate-900 text-white flex flex-col overflow-y-auto">
      {/* Logo */}
